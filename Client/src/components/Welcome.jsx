      ...
      <div className="introduction">
        <div class="row mt-3">
          <div class="col-xl-4 mx-auto mb-1">
            <p>
              ASA Tutoring is a website created by 3 students of the Computer Science branch at the Vrije
              Universiteit Brussel. The website is created with the purpose of assisting VUB students in their
              studies.
            </p>
          </div>
          <div class="col-xl-4 mx-auto mb-1">
            <p>
              Students can search for tutoring posts on courses they are struggling with. They can also create
              Study-Together events with other students to study together.
            </p>
          </div>
        </div>
      </div>
