  ...
  return (
    <div className="navigationbar">
      <Navbar class="navbar" fixed="top" expand="lg">
        ...
        <Nav.Link href={currentUser ? "/groupposts" : "/login"}> <Icon.People size={20} /> Study Together</Nav.Link>
        <Nav.Link href={currentUser ? "/tutoringposts" : "/login"}> <Icon.PersonVideo3 size={20} /> Find tutors</Nav.Link>
